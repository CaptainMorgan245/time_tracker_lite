...
class ClientRow extends DataClass implements Insertable<ClientRow> {
  final int id;
  final String name;
  const ClientRow({required this.id, required this.name});
  @override
  ...
  ClientRow copyWith({int? id, String? name}) =>
      ClientRow(id: id ?? this.id, name: name ?? this.name);
  ...
  bool operator ==(Object other) =>
      ...
      (other is ClientRow && other.id == this.id && other.name == this.name);
}
...
class $ProjectsTable extends Projects
  ...
  @override
  List<GeneratedColumn> get $columns => [id, clientId, name];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class ProjectRow extends DataClass implements Insertable<ProjectRow> {
  ...
  ProjectRow copyWith({int? id, int? clientId, String? name}) => ProjectRow(
    id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, clientId, name);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ProjectRow &&
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> clientId = const Value.absent(),
                Value<String> name = const Value.absent(),
              }) => ProjectsCompanion(id: id, clientId: clientId, name: name),
          createCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                required int clientId,
